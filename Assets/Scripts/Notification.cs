...
namespace murasanca
{
    public class Notification : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            AndroidNotificationChannel androidNotificationChannel = new("D", "Dice", "Just roll with it.", Importance.High)
            {
                CanBypassDnd = true,
                CanShowBadge = true,
            ...
            AndroidNotification androidNotification = new("Dice", "Just roll with it.", DateTime.Now.AddDays(1), new TimeSpan(864000000000), "small") // 864.000.000.000
            {
                Color = Color.yellow,
